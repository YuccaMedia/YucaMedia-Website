...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function initializeAudio() {
        ...
        try {
            ...
            // Use actual MP3 files from the assets directory
            hoverSound.src = "/assets/audio/effects/hover.mp3";
            clickSound.src = "/assets/audio/effects/click.mp3";
            transitionSound.src = "/assets/audio/effects/transition.mp3";
