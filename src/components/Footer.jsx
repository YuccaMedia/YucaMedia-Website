...
const Footer = () => {
  return (
    <footer className="bg-yuca-media-dark text-yuca-media-light py-10">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-8 pt-8 border-t border-yuca-media-light border-opacity-20 text-center text-sm">
