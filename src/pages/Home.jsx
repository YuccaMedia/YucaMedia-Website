    ...
    <>
      ...
      <section className="py-16 bg-[#f5f8f6]">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-[#1a2b21] mb-4 text-center">Creator Dashboard</h2>
          ...
          <div className="flex justify-center">
            <Link 
              ...
              className="bg-[#1a2b21] text-white px-6 py-3 rounded-lg font-medium hover:bg-opacity-90 transition-all text-lg inline-block"
      ...
      {/* Contact CTA Section */}
      <section id="contact-cta" className="py-20 bg-[#1a2b21] text-white">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-2xl mx-auto bg-white/10 backdrop-blur-sm p-8 rounded-lg">
            ...
            <div className="text-center">
              <a 
                href="/contact" 
                className="bg-[#c2c8c4] text-[#1a2b21] px-6 py-3 rounded-lg font-medium hover:bg-opacity-90 transition-all text-lg inline-block"
